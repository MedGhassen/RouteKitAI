...
def run(
    ...
    trace_dir: str | None = typer.Option(None, "--trace-dir", "-t", help="Directory for trace files"),
    ...
    if is_script:
        ...
        console.print(f"[yellow]Note: Direct prompt execution requires a registered agent.[/yellow]")
